...
video_capture = VideoCapture(
    'https://stream-eu1-charlie.dropcam.com:443/nexus_aac/b85a6ec812c045cd921f4164e8e7ecc0/playlist.m3u8?public=GqJifk6U25')
...
while True:
    print(datetime.now(), ' - Processing frame...')
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index] and face_distances[best_match_index] < 0.5:
                try:
                    print('Face detected, connecting to API')
                    name = known_face_names[best_match_index]
                    print(name, ' detected ', best_match_index)
